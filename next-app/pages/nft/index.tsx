...
// todo. move functions to components and lazyloaaaad
const LazyNFTList = dynamic(() => import("../../components/NFTList"), {
  loading: () => (
    <p>
      <svg
        role="status"
        className="w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600 top-1/2 left-1/2"
        viewBox="0 0 100 101"
        fill="none"
  ...
  return (
    <div className="space-y-8">
      <button
        ...
        text-center block items-center mr-10 ml-auto
        "
      >
        Mint
        <svg
